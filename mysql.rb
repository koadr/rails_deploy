Capistrano::Configuration.instance(:must_exist).load do
  namespace :mysql do
    ...
    set :mysqlcmd, lambda { "mysql -h #{mysql_cfg[:host]} -u #{mysql_cfg[:master_user]} --password=#{mysql_cfg[:master_pwd]} -P #{mysql_cfg[:port]}" }
    set :mysqldumpcmd, lambda { "mysqldump -h #{mysql_cfg[:host]} -u #{mysql_cfg[:master_user]} --password=#{mysql_cfg[:master_pwd]}" }
